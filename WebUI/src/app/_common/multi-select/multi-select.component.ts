...
export class MultiSelectComponent implements ControlValueAccessor,OnChanges {
  ...
  _placeholder = "Select";
  private _sourceDataType:any; // to keep note of the source data type. could be array of string/number/object
    ...
    console.log(this._settings)
      this._data = value.map((item: any) =>
        ...
        typeof item === "string" || typeof item === "number"
          ? new ListItem(item)
          : new ListItem({
              id:this._settings?.idField?item[this._settings.idField]:item[this.defaultSettings.idField!],
              text:this._settings?.textField?item[this._settings?.textField]:item[this.defaultSettings.textField!],
              isDisabled: this._settings?.disabledField?item[this._settings.disabledField]:false
            })
      );
          ...
          if (value.length >= 1) {
            ...
            this.selectedItems = [
              typeof firstItem === "string" || typeof firstItem === "number"
                ...
                : new ListItem({
                    id: this._settings?.idField?firstItem[this._settings?.idField]:undefined,
                    text:this._settings?.textField? firstItem[this._settings?.textField]:undefined,
                    isDisabled: this._settings?.disabledField?firstItem[this._settings?.disabledField]:false
                  })
            ];
          }
        } catch (e) {
